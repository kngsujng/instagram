...
export default async function SignInPage({
	...
	return (
		<section className="flex flex-col justify-around items-center mx-auto mt-[20%] px-10 w-1/4 min-w-80 h-80 text-center border-2 border-gray-200 rounded-lg shadow-xl">
			<div>
